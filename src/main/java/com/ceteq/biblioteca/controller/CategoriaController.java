...
public class CategoriaController {
	...
	@PostMapping(path = "/createCategoriaList")
	public ResponseEntity<?> saveLibrosList(@Validated @RequestBody List<CategoriaBean> categoriaBeans,
			BindingResult result) {
		return new ResponseEntity<>(this.categoriaService.saveCategoriaList(categoriaBeans), HttpStatus.OK);
	}
